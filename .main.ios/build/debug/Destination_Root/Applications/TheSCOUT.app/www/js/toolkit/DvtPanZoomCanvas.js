...
DvtPanZoomComponent.prototype.render = function(options, width, height) {
  ...
  //Bug 20301768 - buttons not responding in firefox if hierarchy viewer present
...
DvtPanZoomComponent.prototype._getBackgroundGradient = function(color) {
  ...
  if (color && color != endColor) {
    //Bug 13704008: get alpha from the given color
    ...
    //Bug 13704008: make sure to get the RGB (without alpha) from
...
DvtPanZoomCanvasEventManager.prototype.OnMouseWheel = function(event) {
  ...
  //Bug 17184701: divide by the absolute value of the delta so that the zoom only changes by the increment,
...
DvtPanZoomCanvasEventManager.prototype.ZoomStartTouch = function(event, touch) {
  ...
  if (touchIds.length <= 1) {
    ...
    //Bug 17185041: save the original finger distance
    this._origDist = null;
...
DvtPanZoomCanvasEventManager.prototype.ZoomEndTouch = function(event, touch) {
  if (this._bZooming) {
    //Bug 17185041: clear the original finger distance
    this._origDist = null;
