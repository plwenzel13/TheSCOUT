...
DvtTreemap.prototype._renderIsolateRestore = function(node) {
  ...
  if (this.getOptions()['animationOnDataChange'] != 'none') {
    ...
    // Bug 17562112: the true prevents the options object from being evaluated, so that the isolated node will not
...
DvtTreemapNode.prototype.setSelected = function(selected) {
  ...
  if (this.isSelected()) {
    ...
    if (this._textStyle == DvtTreemapNode.TEXT_STYLE_HEADER) {
      ...
      // Bug 15875065 and Bug 18794536: Disable shadows in safari and ff due to rendering issues.
...
DvtTreemapNode.prototype.showHoverEffect = function() {
  ...
  // Bug 16563380: Do not show the hover effect if the node is not within the isolated subtree.  When a child of an
